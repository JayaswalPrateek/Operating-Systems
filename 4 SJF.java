...
class SJF {
    ...
    static void scheduleSJF(Process[] procList) {
        Arrays.sort(procList, Comparator.comparingInt(proc -> proc.burstTime));
    ...
    static void printSJFResults(Process[] procList) {
    ...
    public static void main(String[] args) {
        ...
        scheduleSJF(procList);
        printSJFResults(procList);
    }
}
